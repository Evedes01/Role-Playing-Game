...
Για ν φτιάξω το 2ο επίπεδο, δημιούργησα καιούριο scene στον φάκελο Scenes, και το ονόμασα Level 2. Για την υλοποίησή του αντέγραψα τα περιεχόμενα του hierarchy από το 1ο επίπεδο και τα χησιμοποίησα στο 2, αλλάζοντας ότι χρειαζόταν ειδικά στο Tilemap, αλλά κρατόντας τις ίδιες ρμίσεις.

Για το Cinemachine δημιούργησα έναν καινούριο Collider?????, προσαρμόζοντάς τον στο σχήμα της καινούριας πίστας.
___

Προσέθεσα καινούριους εχθρούς, collectibles και damage zones.

Αφού τελείωσα με την δημιουργία του επιπέδου, γύρισα πίσω στο πρώτο για να βάλω ένα collider/area trigger, που όταν το αγγίζει ο παίχτης θα ενεργοποιείται και θα τον οδηγεεί στην επόμενη πίστα. Το δημιούργησα και το προγραμμάτισα ακολουθόντας [αυτό](https://www.youtube.com/watch?v=dO5BzWYqEdY&t=1012s&ab_channel=CodinginFlow) το tutorial και έδωσα ιδιαίτερη προσοχή στην αρίθμιση των σκηνών, ώστε ο κωδικάς να οδηγεί στην σωστή. Εξού και ξανα καταχώρησα με την σωστή σειρά τις σκηνές στα Build Settings.
...
Σε αυτή την οθόνη οδηγείται ο παίχτης όταν περάσει από το portal στο τέλος του 2ου επιπέδου το οποίο προγραμμάτησα με παρόμοιο τρόπο με το collider/area trigger του 1ου επιπέδου, όμως αυτή της φορά να οδηγεί σε συγκεκριμένη σκηνή και όχι απλά στην επόμενη. 

Σε αυτό το σημείο δοκίμασα να φτιάξω τα particles, τα οποία αποφάσισα ότι θα ήταν σπίθες που βφαίνουν απότις φωτιές του περιβάλλοντος. Ακουλούθησα το tutorial της Ruby και προσέθεσα particle system και για τα particles έβαλα 5 sprites που είχα ζωγραφίσει. Καθόλη τη διάρκεια που προσάρμοζα το σχήμα του συστήματος και το μέγεθος των σπιθών, 
...
Τέλος, προχώρησα στην προσθήκη audio. Έψαξα και βρήκα background music καθώς και όλα τα ηχητικά εφέ που χρειαζόμουν για το παιχνίδι. Ακολούθησα το tutorial της Ruby και μόνο για την τοποθέτηση του εφέ στο portal ακολούθησα το δικό του [tutorial](https://www.youtube.com/watch?v=dO5BzWYqEdY&t=1012s&ab_channel=CodinginFlow) από πριν, προσθέτοντας και μία καθιστέριση εμφάνισης της επόμενης οθόνης ώστα να ακούγεται το εφέ καινα είναι πιο φυσική η μετάβαση.
