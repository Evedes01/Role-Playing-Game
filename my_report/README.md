...
Σε αυτό το μάθημα ασχοληθήκαμε με την δημιουργία 2D platformer παιχνιδιού στην πλατφόρμα Unity.
<br>Εγώ προσωπικά ασχολήθηκα με την περιπέτεια του Pimo να βρει και να επανακτήσει το φως που είχε χάσει.

# Summary

Για το 1ο παραδοτέο ξεκινήσαμε με τα βασικά controller του χαρακτήρα, τη δημιουργία του κόσμου και την διαδικασία για το πως να κάνουμε build and run το παιχνίδι στον browser.
<br><br>Στο 2ο παραδοτέο ήταν η εξέλιξη του κόσμου του παιχνιδιού καθώς και διάφορες αλληλεπιδράσεις με αυτόν, όπως η συλλογή των collectibles και τα damage zones. Επίσης, δώσαμε ζωή στο παιχνίδι προσθέτοντας κινούμενους εχθρούς και animation και projectiles στον πρωταγωνιστή. Τέλος, προσαρμόσαμε την κάμερα για καλύτερη εμπειρία περιήγησης  στο χώρο.
<br><br>Για το τελευταίο παραδοτέο επεκτείναμε τον κόσμο προσθέτοντας και 2η πίστα, ενώ το παιχνίδι ΄πήρε μορφή με την προσθήκη του health bar και του audio. Προστέθηκαν και λεπτομέρειες όπως particles κάνοντας το περιβάλλον ακόμα πιο ζωντανό.
...
Από αυτό το project απέκτησα πολλή εμπειρία. Ήταν ενδιαφέρουσα η διαδικασία για την δημιουργία ενός παιχνιδιού από την αρχή και παρόλο που δεν λειτούργησαν κάποια πράγματα, ήταν μια καλή διδακτική εμπειρία και έμαθα πώς να ψάχνω και να βρίσκω λύσεις σε προβλήματα που προκύπτουν ειδικά στον κώδικα. Με κάθε βήμα παρατηρούσα πόσο ολοκληρωνόταν το παιχνίδι, και κατανόησα ότι η πιθανότητες που δίνονται είναι αμέτρητες. Επίσης, το γεγονός ότι σχεδίασα τα δικά μου assets με κάνει να αισθάνομαι αυτό το παιχνίδι ακόμα πιο δικό μου και μου έδειξε ότι μπορώ να υλοποιήσω τις ιδέες μου χωρίς περιορισμούς.
